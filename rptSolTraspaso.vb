...
Public Class rptSolTraspaso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjTraspasos.rptSolTraspaso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSolTraspaso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSolTraspaso = New rptSolTraspaso()
        rpt.Site = Me.Site
        Return rpt
    End Function
